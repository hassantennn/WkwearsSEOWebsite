      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        <div className="w-full">
          ...
          <div className="px-4 md:px-8">
            <h3 className="text-xl font-semibold uppercase mb-2 text-gray-900 tracking-wider font-['Playfair_Display'] text-[#d4af37]">              Heritage Grace
            </h3>
        ...
        <div className="w-full">
          ...
          />
          <div className="px-4 md:px-8">
            <h3 className="text-xl font-semibold uppercase mb-2 text-gray-900 tracking-wider font-['Playfair_Display'] text-[#d4af37]">              Noble Form
            </h3>
            <p className="text-gray-700 text-base leading-relaxed">
